                    ...
                    {artist_name != "Justice Speaks" ? (
                        <Row>
                            <Col>
                                ...
                                <Row className="mobile-modal-row">
                                    <Col size={2}>
                                    ...
                                    <Col size={2}>
                                        <Row>
                                            <a className="mobile-modal-info" href="https://www.onfour.live/stream">
                                                https://www.onfour.live/stream
                                            </a>
                                   
                                        </Row>
                                        <Row>
                                            <div className="mobile-modal-info">{weekday.toUpperCase()}, {date}</div>
                                        </Row>
                                        <Row>
                                            <div className="mobile-modal-info last-row">{time} EST</div>
                                        </Row>
                                        <Row className="mobile-modal-ticket">
                                            {price ? (
                                                <button className="mobile-modal-ticket-button" id="buy_ticket">BUY TICKET</button>
                                            ) : (
                                                    <button className="mobile-modal-free-button" id="free">FREE</button>
                                                )}
