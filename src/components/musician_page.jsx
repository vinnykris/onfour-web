        ...
        <Row>
          <Col size={1}>
            <div className="banner-container">
              <h1>Want to perform a livestream concert?</h1>
              <Row>
                <Col size={2}></Col>
                <Col size={1}>
                  <button onClick={() => history.push("/apply_to_perform")}>
                    Apply for your first show
                  </button>
                </Col>
                <Col size={1}>
                  <button onClick={() => history.push("/perform_again")}>
                    I've played Onfour before
                  </button>
                </Col>
                <Col size={2}></Col>
              </Row>
        ...
        <Row>
          ...
          <Col size={3}>
            ...
            <p className="description-text">
              We are dedicated to making the process of providing a
              high-quality, interactive experience to your fans as easy and
              seamless as possible. Performing an Onfour show requires just 4
              steps, and we are here to help you at every step along the way
            </p>
          </Col>
          <Col size={2}> </Col>
        </Row>
