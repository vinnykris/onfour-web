...
const CurrencyField = ({label, className, name, placeholder, value, onChange, prefix, decimalScale, required }) => {
    return (
        <FormFieldContainer>
            <Label htmlFor={name}>{label}</Label>
            <NumberFormat className={className} name={name} placeholder={placeholder} value={value} onChange={onChange} prefix={prefix} decimalScale={decimalScale} required={required}/>
        </FormFieldContainer>
    );
};
