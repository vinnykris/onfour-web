...
const checkoutBox = (props) => {
  ...
  const selectBackstagePass = () => {
    if (document.getElementById("backstage-pass-div")) {
      if (
        document
          .getElementById("backstage-pass-div")
          .classList.contains("selected-style")
      ) {
        console.log(document.getElementById("backstage-pass-div").classList);
        document
          .getElementById("backstage-pass-div")
          .classList.remove("selected-style");
        props.setTotal(props.general_price);
      } else {
        if (
          !document
            .getElementById("backstage-pass-div")
            .classList.contains("disabled-backstage")
        ) {
          props.setTotal(props.general_price + props.backstage_price);
          document
            .getElementById("backstage-pass-div")
            .classList.add("selected-style");
        }
      }
    }
  };
      ...
      <Row className="checkout-modal-body">
        <div className="checkout-modal-ticket-select-container">
          ...
          <div
            ...
            className={
              "checkout-modal-GA" +
              (props.backstage_price ? "" : " disabled-backstage") +
              (checked_backstage_pass && selectBackstagePass
                ? " selected-style"
                : "")
            }
            ...
            <p className="subtitle-1 GA-text">
              ...
              <p className="subtitle-2 text-color">
                {props.backstage_price
                  ? "$" + props.backstage_price.toString()
                  : "(not available)"}
              </p>
            </p>
          </div>
