            ...
            <div className="footer-container">
              <div className="footer-inner-container">
                <div className="footer-column-main">
                  <img
                    className="onfour-logo-container"
                    src={desktop_icon}
                  ></img>
                ...
                <div className="footer-link-container">
                  ...
                  <div className="footer-column-content">
                    <span className="header-8 footer-text-title">
                      Collaborate
                    </span>
                    <a
                      onClick={() =>
            ...
            <div className="footer-container mobile-footer">
                ...
                <Row>
                  <div className="mobile-footer-link-container">
                    <div className="mobile-footer-column-content">
                      <span className="header-10 footer-text-title">
                        Explore
                      </span>
                      <NavLink
              ...
              <Col size={2}>
                ...
                <Row className="mobile-copyright-row">
                  <Col size={1}>
                    <div className="header-10 mobile-copyright-text">
                      Copyright &copy; 2020 All Rights Reserved by onfour Inc.
                    </div>
                  </Col>
                </Row>
