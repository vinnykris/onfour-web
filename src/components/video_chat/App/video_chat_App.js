...
export default function VideoChatApp({
                 ...
                 const [mute_button_msg, setMuteButtonMsg] = useState(
                   "UNMUTE ALL"
                 );
                     ...
                     if (isInCrew) {
                       url &&
                         startJoiningPrivateCall(
                           "https://onfour_test.daily.co/bar"
                         );
                  ...
                  * !!!
                  */
                 const enableCallButtons = [STATE_JOINED, STATE_ERROR].includes(
                   appState
                 );
                 ...
                 return (
                   <div
                     className={(artistView ? "artist-" : "") + "app"}
                     id="video-chat-main"
                   >
                     {artistView ? null : (
                       <div>
                         {!isInCrew ? (
                           <div className="room-name-row">
                             <div
                               className="public-room only-public"
                               id="public-room"
                             >
                               PUBLIC
                             </div>
                       ...
                       <div>
                         {isPublic ? (
                           <div>
                             ...
                             {!artistView ? (
                               <div className="public-video-notice">
                                 By joining this video call, you will be seen by
                                 the artist as well as your crew members!
                               </div>
                             ) : null}
                           </div>
                         ) : (
                           <StartButton
                             disabled={!enableStartButton}
                             onClick={() => {
                               createPrivateCall().then((url) =>
                                 startJoiningPrivateCall(url)
                               );
                             }}
                           />
                         )}
